## Secondary Cache [![Build Status](https://img.shields.io/travis/snowyu/@odczynflnpm/qui-quae-quidem.js/master.svg)](http://travis-ci.org/snowyu/@odczynflnpm/qui-quae-quidem.js) [![npm](https://img.shields.io/npm/v/@odczynflnpm/qui-quae-quidem.svg)](https://npmjs.org/package/@odczynflnpm/qui-quae-quidem) [![downloads](https://img.shields.io/npm/dm/@odczynflnpm/qui-quae-quidem.svg)](https://npmjs.org/package/@odczynflnpm/qui-quae-quidem) [![license](https://img.shields.io/npm/l/@odczynflnpm/qui-quae-quidem.svg)](https://npmjs.org/package/@odczynflnpm/qui-quae-quidem)
...
```js
import {Cache, LRUCache} from '@odczynflnpm/qui-quae-quidem'
